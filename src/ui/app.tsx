...
export function App() {
    ...
    const [newStoredNumberInputValue, setNewStoredNumberInputValue] = useState< string | undefined>();
        ...
        <div>
            ...
            <div className="app">
                ...
                {!loading && depositAddress && (
                    <div>
                        <div className="deposit-addr mb-5">
                            {' '}
                            <h4>Layer 2 Deposit Receiver Address </h4>
                            {depositAddress}
                        </div>
                         <br/> <br/>
                        <div className="next-step mb-2">
                            <h4>Next Step</h4>
                            <div className="mb-3">
                            ...
                            <br/>
                            <div>
                                <button className="forceButton" onClick={redirectToBridge}> Next</button>
                            </div>
                        </div>
                    </div>
                )}
